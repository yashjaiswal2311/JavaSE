...
class Child extends Parent
{
	Child()
	{
		//because here it is byu default calling parent class constructor with 0 argument 
		//super();
...
//error
/*[becoz there is a user defined constructor is in parent class so it can not create a default constructor
 and by default child class constructor is calling super(); like this and there is no constructor with
 0 argument]*/
